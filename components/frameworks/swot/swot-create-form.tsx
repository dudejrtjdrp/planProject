...
export function SwotCreateForm({ projectId, projectFrameworkId, canCreate, type, placeholder }: SwotCreateFormProps) {
  ...
  return (
    <form action={createSwotItemAction} className="space-y-3">
      ...
      />
      {!canCreate ? <p className="text-xs text-amber-600">프로젝트 버전이 없어 SWOT 항목을 추가할 수 없습니다.</p> : null}
