...
import { getSwotItems, getSwotItemsByFrameworkId } from "@/features/swot/data/swot-repository";
...
export default async function ProjectSwotPage({ params, searchParams }: ProjectSwotPageProps) {
  ...
  const swotItems = swotFramework ? await getSwotItemsByFrameworkId(swotFramework.id) : await getSwotItems(id);
